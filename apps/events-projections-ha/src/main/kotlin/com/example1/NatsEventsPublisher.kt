 ...
 */
class NatsEventsPublisher(private val vertx: Vertx, private val nats: StreamingConnection) : EventsPublisher {

    companion object {
        private val log = LoggerFactory.getLogger(NatsEventsPublisher::class.java)
